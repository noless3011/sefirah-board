        ...
        <div className="flex h-screen w-screen flex-col overflow-hidden bg-slate-50 font-sans text-slate-800 antialiased">
            ...
            <header className="sticky top-0 z-40 w-full border-b border-slate-100 bg-white">
                ...
                <div className="flex h-14 items-center justify-between px-4 sm:h-16 sm:px-6">
                    ...
                    {/* Nav tabs — desktop/tablet: nằm giữa header */}
                    <nav className="absolute left-1/2 top-0 hidden h-full -translate-x-1/2 items-center gap-8 sm:flex">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        {/* Settings — ẩn trên mobile */}
                        <button
                            onClick={() => navigate("/settings")}
                            className={`hidden sm:block rounded-lg p-1.5 text-slate-500 hover:bg-slate-100 hover:text-slate-800 transition ${location.pathname === "/settings" ? "bg-slate-100 text-slate-800" : ""}`}
                        >
                            <svg
                                className="h-5 w-5"
                                fill="none"
                            ...
                            >
                                {user?.avatarUrl ? (
                                    ...
                                    >
                                        ...
                                        />
                                        <path
                                            d="M9 14C9 10 12 8 16 8C20 8 23 10 23 14C23 11 20 10 16 10C12 10 9 11 9 14Z"
                                            fill="#78350F"
                                        />
                                        <path
                                            d="M12 9C13.5 7.5 18.5 7.5 20 9C21.5 10.5 20 12 19 12C18 12 15 10.5 13 11C11.5 11.5 11 10 12 9Z"
                                            fill="#78350F"
                                        />
                                        <circle
                                            cx="14"
                                        ...
                                        />
                                        <path
                                            d="M14.5 18C15 18.5 17 18.5 17.5 18"
                                            stroke="#1E293B"
                                            strokeWidth="0.75"
                                            strokeLinecap="round"
                                        />
                                        <path
                                            d="M6 28C6 24 10 22 16 22C22 22 26 24 26 28V32H6V28Z"
                                            fill="#10B981"
                                        />
                                        <path
                                            d="M13 22L16 25L19 22"
                                            stroke="#FDBA74"
                                            strokeWidth="1.5"
                                            strokeLinecap="round"
                                        />
                            ...
                            {showProfileDropdown && (
                                <>
                                    ...
                                    <div className="absolute right-0 mt-2 w-48 rounded-xl border border-slate-150 bg-white p-1.5 shadow-lg ring-1 ring-black/5 z-50">
                                        ...
                                        {/* Settings trong dropdown — hiện trên mobile thay cho icon ngoài */}
                                        <button
                                            onClick={() => {
                                                setShowProfileDropdown(false);
                                                navigate("/settings");
                ...
                {/* Row 2: Nav tabs — chỉ hiện trên mobile */}
                <nav className="flex sm:hidden border-t border-slate-100">
                    {navLinks.map(({ label, path }) => (
                        <NavLink
                            ...
                            to={path}
                            className={({ isActive }) =>
                                `flex-1 py-2.5 text-center text-sm font-semibold border-b-2 transition-colors ${
                                    isActive
                                        ? "text-blue-600 border-blue-600"
                                        : "text-slate-500 border-transparent hover:text-slate-800"
                                }`
