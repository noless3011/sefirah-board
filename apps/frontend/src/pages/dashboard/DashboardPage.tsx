    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-lg rounded-2xl bg-white p-10 text-center shadow-xl">
        ...
        <div className="my-6 rounded-lg bg-blue-50 p-4 text-sm text-blue-800">
          <p>
            <strong>Lưu ý:</strong> Giao diện tính năng chi tiết của Dashboard sẽ do đồng đội của bạn phát triển và ghép vào sau. Nhiệm vụ Authentication của bạn đến đây là hoàn hảo! 🚀
          </p>
        </div>
