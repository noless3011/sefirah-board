...
const generatedSchemas = {
    ...
    UpdatePreferencesPayload: zodToOpenApiSchema(
        UpdatePreferencesPayloadSchema,
    ),
    DeactivateAccountPayload: zodToOpenApiSchema(
        DeactivateAccountPayloadSchema,
    ),
            ...
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/GoogleOAuthPayload",
                            },
                        },
                    },
                },
            ...
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/GitHubOAuthPayload",
                            },
                        },
                    },
                },
            ...
            delete: {
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/DeactivateAccountPayload",
                            },
                        },
                    },
                },
            ...
            patch: {
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/UpdatePreferencesPayload",
                            },
                        },
                    },
                },
                ...
                responses: {
                    "200": {
                        ...
                        content: {
                            "application/json": {
                                schema: {
                                    $ref: "#/components/schemas/PaginatedBoardResponse",
                                },
                            },
                        },
                    },
            ...
            post: {
                ...
                requestBody: {
                    ...
                    content: {
                        "application/json": {
                            schema: {
                                $ref: "#/components/schemas/RedeemInvitePayload",
                            },
                        },
                    },
                },
