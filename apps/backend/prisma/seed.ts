...
async function main() {
    ...
    await prisma.template.create({
        data: {
            ...
            description:
                "Map out complex architecture and user logic with precision-aligned connectors.",
            category: "Flowcharts",
            thumbnailUrl:
                "https://placehold.co/600x400?text=Flowchart+Template",
            elements: [
                {
                    type: "rectangle",
                    x: 100,
    ...
    await prisma.template.create({
        data: {
            ...
            description:
                "A freeform space for quick ideation and sticky note grouping.",
            category: "Brainstorming",
            thumbnailUrl:
                "https://placehold.co/600x400?text=Brainstorming+Template",
            elements: [
                {
                    type: "sticky_note",
                    x: 200,
